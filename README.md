...
[![CI](https://github.com/hitraa/mavlink-doctor/actions/workflows/ci.yml/badge.svg)](https://github.com/hitraa/mavlink-doctor/actions/workflows/ci.yml)
[![Release](https://github.com/hitraa/mavlink-doctor/actions/workflows/release.yml/badge.svg)](https://github.com/hitraa/mavlink-doctor/actions/workflows/release.yml)
[![Go Version](https://img.shields.io/github/go-mod/go-version/hitraa/mavlink-doctor)](https://golang.org)
...
Download the latest pre-compiled binary for Linux, macOS, or Windows from the [Releases](https://github.com/hitraa/mavlink-doctor/releases) page.

#### From Source

```bash
git clone https://github.com/hitraa/mavlink-doctor.git
cd mavlink-doctor
make build
